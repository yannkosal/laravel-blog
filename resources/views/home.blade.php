<x-app-layout title="Home Page">
    @section('hero')
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
                {{ __('home.hero.title') }}
                <span class="text-red-500">Yann Kosal</span>
            </h1>
    ...
    <div class="mb-10 w-full">
        <div class="mb-16">
            <h2 class="mt-16 mb-5 text-3xl text-red-500 font-bold">{{ __('home.recent_posts') }}</h2>
            <div class="w-full">
            ...
            <a class="mt-10 block text-center text-lg text-red-500 font-semibold" href="{{ route('posts.blog') }}">
                {{ __('home.more_posts') }}
            </a>
        </div>
        <hr>
